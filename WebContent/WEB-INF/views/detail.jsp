            ...
            <c:forEach var="pr" items="${item}">
				...
				<c:if test="${pr.status==1 }">
					<div class="btn">
					    ...
					    <br>
					    <a href="${pageContext.request.contextPath}/home/shopping.htm?id=${pr.id }&name=${pr.name }&coler=${pr.coler}&gia=${pr.price }&image=${pr.img1}">Thêm</a>
					</div>
				</c:if>
				<!-- <c:if test="${pr.status!=1 }">
					<div class="btn">
